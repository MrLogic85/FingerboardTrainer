...
public class TextToSpeechManager {
    ...
    private Map<String, File> mSpeachMap = new HashMap<>();

    private Map<String, MediaPlayer> mMediaMap = new HashMap<>();
    ...
    public void prepareTextToSay(String text) {
        ...
        try {
            ...
            Log.d(MainActivity.TAG, "Synthesizing to file " + tmpfile.getAbsolutePath());
            ...
            if (res == TextToSpeech.SUCCESS) {
                Log.d(MainActivity.TAG, "Synthesizing success");
